...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    CalculateBill(){
        ...
        heading.setBounds(90,10,350,25);
        heading.setFont(new Font("Tahoma",Font.PLAIN,22));
        p.add(heading);
        
        
        JLabel lblmeternumber=new JLabel("Meter Number");
        lblmeternumber.setBounds(90,70,100,18);
       ...
       meternumber.setBounds(220,70,180,18);
       p.add(meternumber);
        ...
        lblname=new JLabel("");
        lblname.setBounds(220,100,100,18);
        p.add(lblname);
        ...
        labeladdress.setBounds(220,130,180,18);
        p.add(labeladdress);
        ...
        //
        JLabel lblcity=new JLabel("Unit Consumes");
        lblcity.setBounds(90,160,100,18);
        p.add(lblcity);
        
        tfunits=new JTextField();
        tfunits.setBounds(220,160,180,18);
        p.add(tfunits);
        ...
        cmonth=new Choice();
        cmonth.setBounds(220,190,180,18);
        cmonth.add("January");
        cmonth.add("February");
        cmonth.add("March");
        cmonth.add("April");
        ...
        cancel.setBounds(240,270,90,20);
